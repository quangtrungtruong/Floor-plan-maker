...
var ContextMenu2D = function(blueprint3d) {
          ...
          if (type=="wall")
            selectedItem.remove();
              ...
              scope.floorplan.removeDoor(selectedItem);
                ...
                scope.floorplan.removeWindow(selectedItem);
                else if (type=="room")
                  scope.floorplan.removeRoom(selectedItem);
    ...
    if (type=="wall"){
      ...
      scope.floorplanner.callUpdateTarget();
           ...
           if ($("#input-option1").val()!=null)
            selectedItem.setWidth($("#input-option1").val());
            selectedItem.arrangeWindow(scope.floorplan.walls);
            selectedItem.mergeWithIntersected(scope.floorplan.getWalls());
            scope.floorplanner.callUpdateTarget();
         }
         else if (type=="room")
           if ($("#input-option1").val()!=""){
             selectedItem.setRoomType($("#input-option1").val());
  ...
  function initResize() {
    $("#input-option1").change(changeValue);
  }
